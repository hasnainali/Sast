  ...
  <form name=vicidial_form id=vicidial_form onsubmit="return false;">
   ...
   <!--- Comment on 20 jun 2022 due to show by default RURAL if campaign page not found by ajay after said by hasnain sir-------> 
        ...
        <p><?php
             ...
             /*
            * Checking campaign start with 5 only
            * */
           if(substr($VD_login, 0, 1) === "5"){
               echo "<p>RURAL</p>";
           }else{
               echo $VD_campaign;
           }
      ...
      <div class="tekdial-side-footer">
        ...
        <h4>Copyright © 2021 <br> <a href="https://tcob.vyapaar-vistaar.in/" target="_blank">vyapaar-vistaar Technologies Pvt. Ltd.</a></h4>
      </div>
    </div>
    <!--/tekdial-side-panel-->
        ...
        success:function(res){          
          ...
          // if(res.data.length>0){
            ...
            $.ajax({
              ...
              url:'https://dms.tekzee.in/dms_telecalling/getWebLink',
              beforeSend: function(){
