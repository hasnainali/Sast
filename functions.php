...
function Call_function_logging($function_name,$user,$server_ip,$phone_number){
	$efp = fopen ("./Call_function_logging.txt", "a");
	fwrite ($efp, "$user|$function_name|$phone_number|'\r\n");
	fclose($efp);
}
...
function mysql_to_mysqli($stmt, $link) {
	// $log_file_name = "/var/log/tekdial/FuctionLog/".date("Y-m-d")."_Function.log";
	// writeFunctionLogFile("=====================================",$log_file_name);
	// if(isset($link) && !empty($link) && $link != null){
	// 	$empty = "Link is not null";
	// }else{
	// 	$empty = "Link is null";
	// }
	// writeFunctionLogFile("Statement: ".$stmt." :: Link: ".$empty,$log_file_name);
	// writeFunctionLogFile("=========",$log_file_name);
...
function writeFunctionLogFile($msg,$log_file_name)
    {
